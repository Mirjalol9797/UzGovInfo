...
export default {
  ru: {
    ...
    whatFind: {
      ...
      intro:
        "Раздел gov.uz/toshkent объединяет сведения о столичном хокимияте; полный интерактивный портал — на tashkent.uz.",
      listLabel: "На разделе gov.uz обычно доступны:",
      items: [
        {
          icon: "building",
          title: "О хокимияте",
          desc: "О хокимияте, структура, руководство, центральный аппарат, подведомственные предприятия, территориальные управления",
        },
        {
          icon: "program",
          title: "Деятельность",
          desc: "Перепись, электронное правительство, международное сотрудничество, антикоррупция, молодёжь и гендер",
        },
        {
          icon: "globe",
          title: "Государственные услуги",
          desc: "Сведения о предоставлении услуг; подробный каталог — на портале tashkent.uz",
        },
        {
          icon: "decree",
          title: "Документы",
          desc: "Права на доступ к правительственной информации",
        },
        {
          icon: "chart",
        ...
        },
        {
          ...
          desc: "Новости, календарь, заседания; обратная связь и опросы",
        },
      ],
      closing:
        "Актуальные телефоны и сервисы уточняйте на gov.uz/toshkent и на tashkent.uz.",
    },
    whyUse: {
      h2: "Зачем использовать официальные ресурсы",
      intro:
        "gov.uz/toshkent — официальный раздел хокимията на едином государственном портале; tashkent.uz — интерактивный портал города.",
      listLabel: "Ресурсы полезны:",
      items: [
        "жителям столицы при поиске новостей хокимията и контактов",
        "тем, кому нужны открытые данные и информация о правах доступа к сведениям органов власти",
        "журналистам при работе с пресс-центром и календарём событий",
        "при подаче обращений и использовании городских электронных сервисов на tashkent.uz",
      ],
    },
    otherSites: {
    ...
    schema: {
      ...
      sameAs: [
        ...
        "https://tashkent.uz/ru",
        "https://tashkent.uz/en",
        "https://tashkent.uz/oz",
      ],
    },
    faq: {
      ...
      items: [
        {
          q: "Где официальный раздел хокимията города Ташкента на gov.uz?",
  ...
  en: {
    ...
    whatFind: {
      ...
      intro:
        "gov.uz/toshkent aggregates official information about the capital’s khokimiyat; the full interactive portal is tashkent.uz.",
      listLabel: "On gov.uz you can typically find:",
      items: [
        {
          icon: "building",
          title: "About the administration",
          desc: "About, structure, leadership, central staff, enterprises, territorial departments",
        },
        {
          icon: "program",
          title: "Activities",
          desc: "Census, e-government, international cooperation, anti-corruption, youth and gender",
        },
        {
          icon: "globe",
          title: "Public services",
          desc: "Service provision; detailed catalog on tashkent.uz",
        },
        {
          icon: "decree",
          title: "Documents",
          desc: "Rights of access to government information",
        },
        {
          icon: "chart",
        ...
        },
        {
          ...
          desc: "News, calendar, meetings; feedback and surveys",
        },
      ],
      closing: "Verify phone numbers and services on gov.uz/toshkent and tashkent.uz.",
    },
    whyUse: {
      h2: "Why use these official resources",
      intro:
        "gov.uz/toshkent is the official section on the national portal; tashkent.uz is the city’s interactive portal.",
      listLabel: "These resources are useful for:",
      items: [
        "capital residents seeking khokimiyat news and contacts",
        "anyone needing open data and information on access to government information",
        "journalists using the press centre and event calendar",
        "using city e-services and appeals on tashkent.uz",
      ],
    },
    otherSites: {
    ...
    faq: {
      ...
      items: [
        {
          q: "Where is the official gov.uz section of the Tashkent city khokimiyat?",
  ...
  uz: {
    ...
    whatFind: {
      ...
      intro:
        "gov.uz/toshkent va toliq interaktiv portal tashkent.uz.",
      listLabel: "gov.uz da odatda:",
      items: [
        {
          icon: "building",
          title: "Hokimiyat haqida",
          desc: "Tuzilma, rahbariyat, korxonalar, hududiy boshqarmalar",
        },
        {
          icon: "program",
          title: "Faoliyat",
          desc: "Elektron hukumat, xalqaro hamkorlik, yoshlar va gender",
        },
        {
          icon: "globe",
          title: "Davlat xizmatlari",
          desc: "Xizmatlar; batafsil katalog — tashkent.uz",
        },
        {
          icon: "decree",
          title: "Hujjatlar",
          desc: "Davlat axborotiga kirish huquqlari",
        },
        {
          icon: "chart",
          title: "Raqamli davlat",
          desc: "Ochiq maʼlumotlar",
        },
        {
          icon: "news",
          title: "Matbuot va aloqa",
          desc: "Yangiliklar, taqvim; qayta aloqa",
        },
      ],
      closing: "gov.uz/toshkent va tashkent.uz dan tekshiring.",
    },
    whyUse: {
      h2: "Nima uchun rasmiy resurslardan foydalanish kerak",
      intro:
        "gov.uz/toshkent — yagona davlat portali; tashkent.uz — shahar interaktiv portali.",
      listLabel: "Kimlar uchun:",
      items: [
        "poytaxt fuqarolari va yangiliklar qidiruvchilar uchun",
        "ochiq maʼlumot va huquqlar boʻyicha maʼlumot kerak boʻlganlar uchun",
        "matbuot va murojaatlar uchun",
      ],
    },
    otherSites: {
    ...
    faq: {
      ...
      items: [
        {
          q: "gov.uz dagi rasmiy boʻlim qayerda?",
