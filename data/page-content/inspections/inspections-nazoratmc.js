/**
 * Инспекция по контролю в сфере строительства и жилищно-коммунального хозяйства при Кабинете Министров
 * Официальный раздел: https://gov.uz/ru/nazoratmc
 */
export default {
  ru: {
    pageTitle:
    ...
    whatFind: {
      ...
      intro:
        "Раздел gov.uz/nazoratmc объединяет полномочия инспекции и открытую информацию.",
      listLabel: "На разделе обычно доступны:",
      items: [
        {
          icon: "building",
          title: "Об инспекции",
          desc: "Об инспекции, структура, руководство, центральный аппарат, подведомственные предприятия, территориальные управления, работа в инспекции, общественный совет",
        },
        {
          icon: "program",
          title: "Деятельность",
          desc: "Отчёты, опасные строительные материалы, противодействие коррупции, цифровизация, ЖКХ, контроль в строительстве, электронное правительство, международное сотрудничество, молодёжная и гендерная политика",
        },
        {
          icon: "globe",
          title: "Государственные услуги",
          desc: "Вопросы и ответы, ЕПИГУ",
        },
        {
          icon: "decree",
          title: "Документы",
          desc: "Указ УП-66 и другие акты по контролю в строительстве и ЖКХ",
        },
        {
          icon: "chart",
          title: "Цифровое правительство",
          desc: "Сведения о программах, указы об открытости и общественном контроле (в т.ч. УП-6247)",
        },
        {
          icon: "news",
          title: "Пресс-центр и контакты",
          desc: "Новости, выступления руководства, календарь, заседания, пресс-конференции; контакты, опросы, обратная связь",
        },
      ],
      closing:
        "Состав меню обновляется; актуальные требования смотрите на gov.uz/nazoratmc.",
    },
    whyUse: {
      h2: "Зачем использовать официальный раздел",
      intro:
        "gov.uz/nazoratmc — канал официальной информации инспекции на едином правительственном портале.",
      listLabel: "Раздел особенно полезен:",
      items: [
        "организациям строительного комплекса и ЖКХ при соблюдении требований надзора",
        "застройщикам и подрядчикам при работе с нормативными актами и обращениями",
        "проектным и эксплуатационным службам при поиске официальных разъяснений",
    ...
    schema: {
      ...
      orgName:
        "Инспекция по контролю в сфере строительства и жилищно-коммунального хозяйства при Кабинете Министров Республики Узбекистан",
      sameAs: [
        "https://gov.uz/ru/nazoratmc",
        "https://gov.uz/en/nazoratmc",
        "https://gov.uz/oz/nazoratmc",
      ],
    },
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Инспекция действует при Кабинете Министров Республики Узбекистан. Сведения о структуре и руководстве — в разделах «Об инспекции» и «Структура инспекции» на https://gov.uz/ru/nazoratmc.",
        },
        {
          q: "Где Указ УП-66 и материалы по контролю в строительстве?",
          a: "В разделе «Документы» на gov.uz/nazoratmc.",
        },
        {
          q: "Где ЕПИГУ?",
          a: "Ссылка на единый портал интерактивных государственных услуг — в разделе «Государственные услуги» на разделе nazoratmc.",
        },
      ],
    },
  },
  en: {
    ...
    whatFind: {
      ...
      intro:
        "gov.uz/nazoratmc brings together the inspection’s mandate and public information.",
      listLabel: "You can typically find:",
      items: [
        {
          icon: "building",
          title: "About the inspection",
          desc: "About the inspection, structure, leadership, central staff, subordinate enterprises, territorial departments, careers, public council",
        },
        {
          icon: "program",
          title: "Activity",
          desc: "Reports, hazardous construction materials register, anti-corruption, digitalization, utilities, construction oversight, e-government, international cooperation, youth and gender policy",
        },
        {
          icon: "globe",
          title: "Public services",
          desc: "FAQ, EPIGU unified portal",
        },
        {
          icon: "decree",
          title: "Documents",
          desc: "Decree UP-66 and other acts on construction and utilities oversight",
        },
        {
          icon: "chart",
          title: "Digital government",
          desc: "Program summaries, decrees on openness and public oversight (including UP-6247)",
        },
        {
          icon: "news",
          title: "Press center and contacts",
          desc: "News, leadership statements, calendar, meetings, press conferences; contacts, surveys, feedback",
        },
      ],
      closing: "Menus are updated; confirm current requirements on gov.uz/nazoratmc.",
    },
    whyUse: {
      h2: "Why use this official resource",
      intro:
        "gov.uz/nazoratmc is the inspection’s official channel on Uzbekistan’s government portal.",
      listLabel: "It is especially useful for:",
      items: [
        "construction and utilities organizations meeting supervision requirements",
        "developers and contractors working with regulations and appeals",
        "design and operations teams seeking official guidance",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "The inspection operates under the Cabinet of Ministers of Uzbekistan. Structure and leadership are under About the inspection and Structure of the inspection on https://gov.uz/en/nazoratmc.",
        },
        {
          q: "Where is Decree UP-66?",
          a: "Under Documents on gov.uz/nazoratmc.",
        },
        {
          q: "Where is EPIGU?",
          a: "Linked under Public services on the nazoratmc section.",
        },
      ],
    },
  },
  uz: {
    ...
    whatFind: {
      ...
      intro:
        "gov.uz/nazoratmc inspeksiya vakolati va ochiq axborotni birlashtiradi.",
      listLabel: "Odatda mavjud:",
      items: [
        {
          icon: "building",
          title: "Inspeksiya haqida",
          desc: "Inspeksiya haqida, tuzilma, rahbariyat, markaziy apparat, boʻysunuvchi korxonalar, hududiy boshqarmalar, ish, jamoat kengashi",
        },
        {
          icon: "program",
          title: "Faoliyat",
          desc: "Hisobotlar, xavfli materiallar, korrupsiyaga qarshi kurash, raqamlashtirish, MJKX, qurilish nazorati, elektron hukumat, xalqaro hamkorlik",
        },
        {
          icon: "globe",
          title: "Davlat xizmatlari",
          desc: "Savollar-javoblar, EPIGU",
        },
        {
          icon: "decree",
          title: "Hujjatlar",
          desc: "УП-66 va boshqa qurilish va MJKX nazorati hujjatlari",
        },
        {
          icon: "chart",
          title: "Raqamli davlat",
          desc: "Dasturlar, ochiq faoliyat va jamoat nazorati boʻyicha farmonlar (УП-6247)",
        },
        {
          icon: "news",
          title: "Matbuot markazi va aloqa",
          desc: "Yangiliklar, rahbariyat nutqlari, tadbirlar, uchrashuvlar; kontaktlar, soʻrovnomalar",
        },
      ],
      closing:
        "Menyu yangilanadi; dolzarb talablarni gov.uz/nazoratmc dan tekshiring.",
    },
    whyUse: {
      h2: "Nima uchun rasmiy boʻlimdan foydalanish kerak",
      intro:
        "gov.uz/nazoratmc — yagona davlat portali boʻyicha inspeksiyaning rasmiy axborot kanali.",
      listLabel: "U ayniqsa quyidagilar uchun muhim:",
      items: [
        "qurilish va MJKX nazorati talablariga rioya qiluvchi tashkilotlar uchun",
        "loyihachilar va pudratchilar uchun meʼyoriy hujjatlar va murojaatlar bilan ishlashda",
        "rasmiy izohlarni qidiruvchi loyiha va ekspluatatsiya xizmatlari uchun",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Oʻzbekiston Respublikasi Vazirlar Mahkamasi huzurida. Tuzilma — «Inspeksiya haqida» va «Inspeksiya tuzilmasi» boʻlimlarida: https://gov.uz/oz/nazoratmc.",
        },
        {
          q: "УП-66 Farmoni qayerda?",
          a: "gov.uz/nazoratmc dagi «Hujjatlar» boʻlimida.",
        },
        {
          q: "EPIGU qayerda?",
          a: "«Davlat xizmatlari» boʻlimida nazoratmc sahifasida havola.",
        },
      ],
    },
  },
