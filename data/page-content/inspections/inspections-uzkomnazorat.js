 ...
 * Официальный раздел: https://gov.uz/ru/uzkomnazorat
 */
export default {
  ru: {
    pageTitle:
    ...
    whatFind: {
      ...
      intro:
        "Раздел gov.uz/uzkomnazorat объединяет полномочия инспекции и открытую информацию.",
      ...
      items: [
        ...
        },
        {
          icon: "program",
          title: "Деятельность",
          desc: "Стратегия 2022–2026, отчёты, молодёжная политика, планы, противодействие коррупции, электронное правительство, международное сотрудничество, антимонопольное законодательство, общественный совет",
        },
        {
          icon: "globe",
          title: "Государственные услуги",
          desc: "Вопросы и ответы, материалы для субъектов предпринимательства",
        },
        {
          icon: "decree",
          title: "Документы",
          desc: "Законы, акты Президента и Кабинета Министров, стандарты, правила, проекты НПА",
        },
        {
          icon: "chart",
          title: "Цифровое правительство",
          desc: "Реестр открытых данных, открытая информация о бюджете инспекции, предложения по открытости",
        },
        {
          icon: "news",
          title: "Пресс-центр и контакты",
          desc: "Новости, семинары, галереи, объявления, календарь; контакты, обратная связь, статистика обращений",
        },
      ],
      closing:
        "Состав меню обновляется; актуальные требования смотрите на gov.uz/uzkomnazorat.",
    },
    whyUse: {
      h2: "Зачем использовать официальный раздел",
      intro:
        "gov.uz/uzkomnazorat — канал официальной информации инспекции на едином правительственном портале.",
      listLabel: "Раздел особенно полезен:",
      items: [
        "организациям связи и ИТ при соблюдении требований надзора",
        "субъектам предпринимательства при работе с нормативными актами и обращениями",
        "специалистам при поиске официальных разъяснений",
    ...
    schema: {
      ...
      orgName:
        "Инспекция по контролю в сфере информатизации и телекоммуникаций при Министерстве цифровых технологий «Узкомназорат»",
      sameAs: [
        "https://gov.uz/ru/uzkomnazorat",
        "https://gov.uz/en/uzkomnazorat",
        "https://gov.uz/oz/uzkomnazorat",
      ],
    },
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Инспекция действует при Министерстве цифровых технологий Республики Узбекистан. Сведения о структуре и руководстве — в разделах «Об организации» на https://gov.uz/ru/uzkomnazorat.",
        },
        {
          q: "Где открытые данные и информация о бюджете инспекции?",
          a: "В блоке «Цифровое правительство» на gov.uz/uzkomnazorat.",
        },
        {
          q: "Где материалы для предпринимателей?",
          a: "В разделе «Государственные услуги» — «Для субъектов предпринимательства» на официальном разделе.",
        },
      ],
    },
  },
  en: {
    ...
    whatFind: {
      ...
      intro:
        "gov.uz/uzkomnazorat brings together the inspection’s mandate and public information.",
      listLabel: "You can typically find:",
      items: [
        {
          icon: "building",
          title: "About the organization",
          desc: "About the inspection, structure, leadership, central office, subordinate enterprises, territorial departments, vacancies",
        },
        {
          icon: "program",
          title: "Activity",
          desc: "Strategy 2022–2026, reports, youth policy, plans, anti-corruption, e-government, international cooperation, antimonopoly legislation, public council",
        },
        {
          icon: "globe",
          title: "Public services",
          desc: "FAQ, materials for business entities",
        },
        {
          icon: "decree",
          title: "Documents",
          desc: "Laws, presidential and Cabinet acts, standards, rules, draft regulations",
        },
        {
          icon: "chart",
          title: "Digital government",
          desc: "Open data register, open budget information of the inspection, openness proposals",
        },
        {
          icon: "news",
          title: "Press center and contacts",
          desc: "News, seminars, galleries, announcements, calendar; contacts, feedback, appeal statistics",
        },
      ],
      closing:
        "Menus are updated; confirm current requirements on gov.uz/uzkomnazorat.",
    },
    whyUse: {
      h2: "Why use this official resource",
      intro:
        "gov.uz/uzkomnazorat is the inspection’s official channel on Uzbekistan’s government portal.",
      listLabel: "It is especially useful for:",
      items: [
        "telecom and IT organizations meeting supervision requirements",
        "businesses working with regulations and appeals",
        "professionals seeking official guidance",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "The inspection operates under the Ministry of Digital Technologies of Uzbekistan. Structure and leadership are under About the organization on https://gov.uz/en/uzkomnazorat.",
        },
        {
          q: "Where are open data and the inspection’s budget information?",
          a: "Under Digital government on gov.uz/uzkomnazorat.",
        },
        {
          q: "Where are materials for entrepreneurs?",
          a: "Under Public services — For business entities on the official section.",
        },
      ],
    },
  },
  uz: {
    ...
    whatFind: {
      ...
      intro:
        "gov.uz/uzkomnazorat inspeksiya vakolati va ochiq axborotni birlashtiradi.",
      listLabel: "Odatda mavjud:",
      items: [
        {
          icon: "building",
          title: "Tashkilot haqida",
          desc: "Inspeksiya haqida, tuzilma, rahbariyat, markaziy apparat, boʻysunuvchi korxonalar, hududiy boshqarmalar, boʻsh ish oʻrinlari",
        },
        {
          icon: "program",
          title: "Faoliyat",
          desc: "2022–2026 strategiyasi, hisobotlar, yoshlar siyosati, rejalar, korrupsiyaga qarshi kurash, elektron hukumat, xalqaro hamkorlik, antimonopol qonunchilik, jamoat kengashi",
        },
        {
          icon: "globe",
          title: "Davlat xizmatlari",
          desc: "Savollar-javoblar, tadbirkorlik subyektlariga materiallar",
        },
        {
          icon: "decree",
          title: "Hujjatlar",
          desc: "Qonunlar, Prezident va Vazirlar Mahkamasi hujjatlari, standartlar, qoidalar, loyiha NPHlar",
        },
        {
          icon: "chart",
          title: "Raqamli davlat",
          desc: "Ochiq maʼlumotlar reyestri, byudjet boʻyicha ochiq maʼlumotlar, ochiqlik boʻyicha takliflar",
        },
        {
          icon: "news",
          title: "Matbuot va aloqa",
          desc: "Yangiliklar, seminarlar, galereyalar, eʼlonlar; kontaktlar, qayta aloqa, murojaatlar statistikasi",
        },
      ],
      closing:
        "Menyu yangilanadi; dolzarb talablarni gov.uz/uzkomnazorat dan tekshiring.",
    },
    whyUse: {
      h2: "Nima uchun rasmiy boʻlimdan foydalanish kerak",
      intro:
        "gov.uz/uzkomnazorat — yagona davlat portali boʻyicha inspeksiyaning rasmiy axborot kanali.",
      listLabel: "U ayniqsa quyidagilar uchun muhim:",
      items: [
        "nazorat talablariga rioya qiluvchi aloqa va IT tashkilotlari uchun",
        "meʼyoriy hujjatlar va murojaatlar bilan ishlovchi tadbirkorlar uchun",
        "rasmiy izohlarni qidiruvchi mutaxassislar uchun",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Oʻzbekiston Respublikasi Raqamli texnologiyalar vazirligi huzurida. «Tashkilot haqida»: https://gov.uz/oz/uzkomnazorat.",
        },
        {
          q: "Ochiq maʼlumotlar va byudjet maʼlumotlari qayerda?",
          a: "«Raqamli davlat» boʻlimida gov.uz/uzkomnazorat da.",
        },
        {
          q: "Tadbirkorlar uchun materiallar qayerda?",
          a: "«Davlat xizmatlari» — «Tadbirkorlik subyektlariga» rasmiy boʻlimda.",
        },
      ],
    },
  },
