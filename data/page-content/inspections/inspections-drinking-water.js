 ...
 * Официальный раздел: https://gov.uz/ru/vnadzor
 */
export default {
  ru: {
    pageTitle:
      ...
      items: [
        {
          icon: "building",
          title: "Об инспекции",
          desc: "Об инспекции, структура организации, руководство, центральный аппарат, подведомственные предприятия, территориальные управления, вакансии",
        },
        {
          icon: "program",
          title: "Деятельность",
          desc: "Стратегия 2022–2026, молодёжная политика, противодействие коррупции, программы, антимонопольное законодательство, советы, международное сотрудничество, гендерное равенство",
        },
        {
          icon: "globe",
          title: "Государственные услуги",
          desc: "Вопросы и ответы, график работы (на других языках — дополнительные подразделы, например электронное правительство)",
        },
        {
          icon: "decree",
          title: "Документы",
          desc: "Конституция, законы, акты Президента и Кабмина, проекты, документы по предпринимательству, нормативные акты инспекции, статистика, перечни сведений",
        },
        {
          icon: "chart",
          title: "Цифровое правительство",
          desc: "Сведения по УК-6247, финансовые отчёты, сведения общественного интереса, реестр открытых данных, жалобы по открытости, борьба с коррупцией",
        },
        {
          icon: "news",
          title: "Пресс-центр и контакты",
          desc: "Новости, библиотека, выступления руководства, пресс-мероприятия; контакты, обращения граждан, обратная связь, статистика обращений",
        },
      ],
      closing:
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "В подразделах «Государственные услуги» на https://gov.uz/ru/vnadzor: вопросы и ответы, график работы.",
        },
        {
          q: "Где открытые данные и финансовые отчёты?",
          a: "В блоке «Цифровое правительство» на gov.uz/vnadzor: сведения по УК-6247, финансовые отчёты, реестр открытых данных и др. (актуальное меню на портале).",
        },
        {
          q: "Кому подчиняется инспекция и где описана структура?",
          a: "Инспекция действует при Министерстве водного хозяйства Республики Узбекистан. Сведения — в разделах «Об инспекции» и «Структура организации» на https://gov.uz/ru/vnadzor.",
        },
      ],
    },
  },
