...
const otherSites = computed(() => {
  ...
  const slugToIcon = (slug) => {
    ...
    if (s.includes("inspections-kontexnazorat")) return "globe";
    if (s.includes("inspections-uzstdepartament")) return "decree";
...
const contactSocialMarkup = {
  ...
  uforum: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="19" viewBox="0 0 14 19" fill="currentColor" class="w-[14px] h-[19px]" aria-hidden="true"><path fill-rule="evenodd" d="M0 0c.94 8.402 3.272 18.967 7.095 19 3.66-.127 6.183-12.12 6.903-16.42-1.689 4.322-4.327 11.304-6.805 11.645C4.408 14.065 1.683 5.77.003 0z" clip-rule="evenodd"/></svg>`,
