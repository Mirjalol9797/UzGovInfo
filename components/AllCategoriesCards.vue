...
const categoryIcons = {
  ...
  banks: `<svg viewBox="0 0 24 24" fill="none"><path d="M4 10h16v2H4v-2zM4 6h16v2H4V6zm4 6v6h6v-6H8z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M6 18h12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  centers: `<svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.6"/><path d="M12 8V12L14 14" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.6" stroke-dasharray="4 3"/></svg>`,
...
const categoryCards = computed(() => [
  ...
  },
  {
    key: "centers",
    href: "/centers",
    label: t("otherSites.centers"),
    count: centers.data.length,
    bg: "#e0f7fa",
    color: "#0d9488",
  },
  {
  ...
  },
  {
    key: "hokimiyats",
    href: "/hokimiyats",
    label: t("otherSites.hokimiyats"),
    count: hokimiyats.data.length,
    bg: "#e8f5e9",
    color: "#2e7d32",
  },
]);
